        ...
        <div className="flex max-w-6xl mx-auto py-24">
          <div className="max-w-lg">
            ...
            <div className="text-base text-black font-normal px-5">
              <p>
                I am available for full time, part time and freelance. Connect
                with me and let's talk about everything.
              </p>
            </div>
          ...
          <div className="flex border p-5">
            <form action="">
              ...
              <div className="text-center pt-6">
                <button className="border rounded-lg px-5 py-2 bg-[#a3262e] text-white">
                  Send message
                </button>
              </div>
            </form>
